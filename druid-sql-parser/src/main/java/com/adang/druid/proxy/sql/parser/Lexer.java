 ...
 */
package com.adang.druid.proxy.sql.parser;


import com.adang.druid.proxy.sql.ast.expr.SQLNumberExpr;
import com.adang.druid.proxy.sql.dialect.mysql.parser.MySqlLexer;
import com.adang.druid.proxy.util.FnvHash;
import com.adang.druid.proxy.util.JdbcConstants;
import com.adang.druid.proxy.util.StringUtils;
...
import static com.adang.druid.proxy.sql.parser.CharTypes.isFirstIdentifierChar;
import static com.adang.druid.proxy.sql.parser.CharTypes.isIdentifierChar;
import static com.adang.druid.proxy.sql.parser.CharTypes.isWhitespace;
import static com.adang.druid.proxy.sql.parser.LayoutCharacters.EOI;
import static com.adang.druid.proxy.sql.parser.SQLParserFeature.KeepComments;
import static com.adang.druid.proxy.sql.parser.SQLParserFeature.OptimizedForParameterized;
import static com.adang.druid.proxy.sql.parser.SQLParserFeature.SkipComments;
import static com.adang.druid.proxy.sql.parser.Token.*;
import static com.adang.druid.proxy.sql.parser.Token.COLONCOLON;
import static com.adang.druid.proxy.sql.parser.Token.COLONEQ;
import static com.adang.druid.proxy.sql.parser.Token.COMMA;
import static com.adang.druid.proxy.sql.parser.Token.DOT;
import static com.adang.druid.proxy.sql.parser.Token.EOF;
import static com.adang.druid.proxy.sql.parser.Token.EQ;
import static com.adang.druid.proxy.sql.parser.Token.ERROR;
import static com.adang.druid.proxy.sql.parser.Token.LBRACE;
import static com.adang.druid.proxy.sql.parser.Token.LBRACKET;
import static com.adang.druid.proxy.sql.parser.Token.LITERAL_ALIAS;
import static com.adang.druid.proxy.sql.parser.Token.LITERAL_CHARS;
import static com.adang.druid.proxy.sql.parser.Token.LPAREN;
import static com.adang.druid.proxy.sql.parser.Token.RBRACE;
import static com.adang.druid.proxy.sql.parser.Token.RBRACKET;
import static com.adang.druid.proxy.sql.parser.Token.RPAREN;
